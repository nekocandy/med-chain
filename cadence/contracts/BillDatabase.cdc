pub contract BillDatabase {
    pub struct Bill {
        ...
        init(bill_id: String, expense: String, amount: Int, email: String) {
    ...
    pub fun add_bill(bill_id: String, expense: String, amount: Int, email: String) {
        let bill = Bill(bill_id: bill_id, expense: expense, amount: amount, email: email)
